  ...
  return (
    <header className="header">
      ...
      <nav className="header-nav">
        <Link to={routes.main.create()} className="header-link">
          <Text children="Products" view="p-18" className="nav" />
        </Link>
        <Link to={routes.main.create()} className="header-link">
          <Text children="Categories" view="p-18" className="nav" />
        </Link>
        <Link to={routes.main.create()} className="header-link">
          <Text children="About us" view="p-18" className="nav" />
        </Link>
      </nav>
      <div className="icons">
